...
## Описание Проекта
Проект представляет собой фото-блог пользователя подключённую к серверу с возможностью редактирования профиля, добавления карточек с изображениями на стену, удаления карточек, и возможностью их оценить.
